function [kcdf, nscores, h, Supplement] = KCDF_EstimGP(data, kernel,covarianceF)
...
%kcdf = interp1(zval, kcdf_estim, data); % CDF of the data points
        ...
        gprMdl = fitrgp((zval)', kcdf_estim, KernelFunction=covarianceF);
        % Predict the missing values
        kcdf = predict(gprMdl, data);
